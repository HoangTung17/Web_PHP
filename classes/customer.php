...
<?php
	...
	class customer
	{
		...
		public function insert_customers($data){
			...
			if($name=="" || $email=="" || $address=="" || $country=="" || $password ==""){
				...
				if($result_check){
					...
					$query = "INSERT INTO tbl_customer(name,city,email,address,country,phone,password) VALUES('$name','$email','$address','$country','$password')";
